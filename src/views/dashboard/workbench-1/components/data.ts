...
export const dynamicInfoItems: DynamicInfoItem[] = [
  {
    ...
    name: '',
    date: 'Just Now',
    desc: `Enrolling in training programs, GED classes or finding employment. <a>Training</a>  <a>Vue</a>`,
  },
  {
    avatar: 'dynamic-avatar-2|svg',
    name: '',
    date: '1 hour ago',
    desc: `Your life is worth fighting for.Never give up on your dreams.<a>Mental</a> `,
  },
  {
